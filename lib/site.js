...
export const SITE = {
  ...
  socials: {
    ...
    // Paste a free Instagram widget embed URL (LightWidget, Behold.so, or
    // SnapWidget) for @aoa_racing_ here to show a live, auto-updating feed of
    // the newest posts on the homepage. Leave "" to show the Follow fallback.
    instagramEmbedUrl: "",
